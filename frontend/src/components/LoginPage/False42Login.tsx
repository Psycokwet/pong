...
const False42Login = () => {
  ...
  const handleLogin42Change = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center space-y-16 bg-gray-900 text-white h-screen text-center">
      ...
      <form
        action={
          import.meta.env.VITE_PONG_URL_BACK + FULL_ROUTE.AUTH.FALSE_42_LOGIN
        }
        method="get"
      >
